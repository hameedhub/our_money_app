    ...
    return Scaffold(
        ...
        // }).toList()..add(
           FloatingActionButton.extended(
            label: Text('Request Loan', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white)),
            ...
            icon: new AnimatedBuilder(
              ...
              builder: (BuildContext context, Widget child) {
                return new Transform(
                  ...
                  child: new Icon(_controller.isDismissed ? Icons.arrow_forward_ios : Icons.close, color: Colors.white,),
                );
              },
            ),
            onPressed: () {
